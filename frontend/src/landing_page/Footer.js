      ...
      <div className="container border-top mt-5 pt-5">
        <div className="row">
          <div className="col-12 col-md-3 mb-4 mb-md-0">
            <img src="media/images/logo.svg" className="img-fluid mb-2" style={{ maxWidth: "120px" }} alt="Logo" />
            <p>
          ...
          <div className="col-12 col-md-3 mb-4 mb-md-0">
            ...
            <a href="" style={{ textDecoration: "none" }} className="text-muted">60 days challenge</a>
          </div>
        </div>
        <div className="mt-5 fs-9 text-muted" style={{ fontSize: "10px" }}>
          <p>
        ...
        <div className="mb-2 d-flex flex-wrap">
          <a style={{ textDecoration: "none", fontSize: "13px", marginRight: "25px", marginTop: "15px" }} className="text-muted">NSE</a>
          <a style={{ textDecoration: "none", fontSize: "13px", marginRight: "25px", marginTop: "15px" }} className="text-muted">BSE</a>
          <a style={{ textDecoration: "none", fontSize: "13px", marginRight: "25px", marginTop: "15px" }} className="text-muted">MCX</a>
          <a style={{ textDecoration: "none", fontSize: "13px", marginRight: "25px", marginTop: "15px" }} className="text-muted">Terms & conditions</a>
          <a style={{ textDecoration: "none", fontSize: "13px", marginRight: "25px", marginTop: "15px" }} className="text-muted">Policies & procedures</a>
          <a style={{ textDecoration: "none", fontSize: "13px", marginRight: "25px", marginTop: "15px" }} className="text-muted">Privacy policy</a>
          <a style={{ textDecoration: "none", fontSize: "13px", marginRight: "25px", marginTop: "15px" }} className="text-muted">Disclosure</a>
          <a style={{ textDecoration: "none", fontSize: "13px", marginRight: "25px", marginTop: "15px" }} className="text-muted">For investor's attention</a>
          <a style={{ textDecoration: "none", fontSize: "13px", marginRight: "25px", marginTop: "15px" }} className="text-muted">Investor charter</a>
        </div>
      </div>
    </footer>
  );
